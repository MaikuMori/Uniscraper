...
class FuelstationspiderSpider(BaseSpider):
    name = "FuelStationSpider"
    
    export_item = "FuelStation"
    export_items = "FuelStations"
    ...
    def parse(self, response):
        ...
        for station in stations:
            ...
            if gmap:
                item["lat"] = gmap.select("@data-g-coord-x").extract()[0]
                item["lon"] = gmap.select("@data-g-coord-y").extract()[0]
